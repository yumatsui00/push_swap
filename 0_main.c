...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/07 20:17:51 by yumatsui          #+#    #+#             */
/*   Updated: 2024/05/17 13:30:04 by yumatsui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	norm_master(t_node **a, t_node **b, int argc)
{
	(*b)->num = 0;
	(*b)->next = *b;
	(*b)->prev = *b;
